        ...
        <div class="col-lg-5">
            <div class="box box-widget">
                <div class="box-body">
                    <tr>
                        <td >
                            <label  style="height:50px;font-size:25px;text-align:center;" for="cash">Pembayaran</label>
                        </td>
                        <td>
                            <div class="form-group">
                                <input style="color:green;height:80px;font-size:45pt;text-align:center"type="number" min="0" id="cash" value="0" min="0" class="form-control">
                            </div>
                        </td>
                    </tr>
                </div>
                ...
                <div class="box box-widget">
                    <div class="box-body">
                        <table width="100%">
                            ...
                            <tr>
                                <td style="height:60px;font-size:20px;text-align:center">
                                    <label for="change">Kembalian</label>
                                </td>
                                <td>
                                    <div>
                                        <input style="height:60px;font-size:30pt;color:red;text-align:center" type="number" min="0" id="change" class="form-control" readonly>
                                    </div>
                                    <br>
                                </td>
                            </tr>
                            <tr>
                                <td style="height:60px;text-align:center;">
                                    <label  for="discount">Potongan Harga <br>(Tidak Wajib Di isi)</label>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input  style="height:60px;font-size:30pt;text-align:center" type="number" min="0" id="discount" value="0" min="0" class="form-control" required>
                                    </div>
                                </td>
                            </tr>
                        </table>
                ...
                <!-- <div class="box box-widget">
                    <div class="box-body"> -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <textarea style="display:none;" id="note" rows="3" class="form-control"></textarea>
                                </div>
                            </td>
                        </tr>
                    <!-- </div>
