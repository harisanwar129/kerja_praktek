...
class user extends CI_Controller
{
	...
	public function add()
	{
		if (isset($_POST['add'])) {
			...
			$this->form_validation->set_rules('username', 'Nama Pengguna', 'required|min_length[5]|is_unique[user.username]');
			...
			$this->form_validation->set_message('max_length', '{field} minimal 25 karakter');
